...
email `devanshsehgal02@gmail.com` with the subject `rewrite-spring-to-helidon conduct report`.

The maintainer takes reports of violations seriously and will make every effort to respond in a
timely manner. The maintainer will investigate reports by reviewing relevant messages, logs, and
other evidence, or by interviewing witnesses and participants. Investigations and enforcement
will be kept as transparent as possible while prioritizing safety and confidentiality. Enforcement
actions are carried out privately with the involved parties, though communicating to the whole
...
individuals involved and the community as a whole. Depending on severity, lower rungs may be
skipped.
...
2. **Temporarily limited activities**
   1. **Event:** A repeated incident that previously resulted in a warning, or the first incidence
      of a more serious violation.
   2. **Consequence:** A private, written warning with a time-limited cooldown period. The cooldown
      may be limited to particular channels or interactions.
   3. **Repair:** Examples include an apology, reflection during the cooldown, and thoughtful
      re-entry into community spaces.
3. **Temporary suspension**
   1. **Event:** A pattern of repeated violations that warnings have not resolved, or a single
      serious violation.
   2. **Consequence:** A private written notice with conditions for return from suspension.
   3. **Repair:** Examples include respecting the suspension, meeting the conditions for return,
      and thoughtful reintegration into the community.
4. **Permanent ban**
   1. **Event:** A pattern of violations that other steps have failed to resolve, or a violation so
      serious that the maintainer determines the community cannot otherwise be kept safe.
   2. **Consequence:** Access to all community spaces, tools, and communication channels is removed.
   3. **Repair:** There is no possible repair in cases of this severity.

This enforcement ladder is a guideline. It does not limit the maintainer's discretion and judgment
when acting in the community's best interests.
...
[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). The enforcement ladder was
